...
const (
	...
	Raft_RequestVotes_FullMethodName  = "/pb.Raft/RequestVotes"
)
...
type RaftClient interface {
	...
	RequestVotes(ctx context.Context, in *RequestVoteRequest, opts ...grpc.CallOption) (*RequestVoteResponse, error)
}
...
func (c *raftClient) RequestVotes(ctx context.Context, in *RequestVoteRequest, opts ...grpc.CallOption) (*RequestVoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RequestVoteResponse)
	err := c.cc.Invoke(ctx, Raft_RequestVotes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServer interface {
	...
	// Invoked by candidates to gather votes
	RequestVotes(context.Context, *RequestVoteRequest) (*RequestVoteResponse, error)
...
func (UnimplementedRaftServer) RequestVotes(context.Context, *RequestVoteRequest) (*RequestVoteResponse, error) {
...
func _Raft_RequestVotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Raft_RequestVotes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServer).RequestVotes(ctx, req.(*RequestVoteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
